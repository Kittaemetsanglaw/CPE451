...
const AttendanceList = () => {
  ...
  const [students] = useState([
    { id: '65000001', name: 'นาย ณัฐวุฒิ สังขกุล', present: false, absent: false },
    { id: '65000002', name: 'นาย ธนภัทร ศิริเทพ', present: false, absent: false },
    { id: '65000003', name: 'นาย สราวุฒิ เพ็ชรพรหมมาสตร์', present: false, absent: false },
    { id: '65000004', name: 'นาย ชญานนท์ ตัณธนสุข', present: false, absent: false },
    { id: '65000005', name: 'นาย กฤตเมธ สังข์ลาว', present: false, absent: false },
  ]);
